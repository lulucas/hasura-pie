...
type genericHandler func(context.Context, []byte) (interface{}, error)

func (handler genericHandler) Invoke(ctx context.Context, payload []byte) ([]byte, error) {
...
func NewHandler(handlerFunc interface{}) Handler {
	...
	return genericHandler(func(ctx context.Context, payload []byte) (interface{}, error) {
		// construct arguments
		...
		if (handlerType.NumIn() == 1 && !takesContext) || handlerType.NumIn() == 2 {
			...
			if err := json.Unmarshal(payload, conjson.NewUnmarshaler(event.Interface(), transform.ConventionalKeys())); err != nil {
				return nil, err
			}
